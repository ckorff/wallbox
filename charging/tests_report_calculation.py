...
class GenerateMonthlyReportTests(TestCase):
    def test_empty_month_creates_zeroed_row(self):
    ...
    def test_single_tariff_single_session(self):
        ...
        self.assertEqual(report.total_amount_eur, Decimal("3.85"))
    ...
    def test_decimal_precision_rounds_only_at_end(self):
        ...
        self.assertEqual(report.total_amount_eur, Decimal("38.50"))
